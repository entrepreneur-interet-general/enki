...
messagesTable = Table(
    ...
    Column('type', Enum(MessageType, impl=Integer())),
...
user_evenement_role_table = Table(
    ...
    Column('type', Enum(EvenementRoleType, impl=String())),
...
messages_reactions_table = Table(
    ...
    Column('uuid', String(60), primary_key=True),
    Column('creator_id', String(60), ForeignKey("users.uuid")),
    Column('type', Enum(ReactionType, impl=String())),
...
evenementsTable = Table(
    ...
    Column('title', String(255), nullable=False),
    Column('description', String(255)),
    Column('type', Enum(EvenementType, impl=String())),
    Column('creator_id', String(60), ForeignKey("users.uuid")),
